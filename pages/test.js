...
//     useEffect(() => {
//         var effect = document.querySelector("#heroEffects");
//         var shade = document.getElementById("#shadeFace");
...
//                     console.log("detact")
//                     shade.target.style.background = "red"


//                     console.log("Effect on")
//                 } else {
//                     console.log("not setact")
//                 }
//             }
...
//                 <div id="heroEffects" className="heroEffects bg-[url('/assets/hero.jpg')] bg-cover bg-center fixed min-h-screen w-full h-full">
...
//                         </div>
//                     </div>
//                     <div id="shadeFace" className="fixed w-full h-screen"></div>
//                 </div>
//             </section>
...
// //           var Num = window.scrollTo(0, 0) / 500;
// //           var Num = window.scrollTo(0, 0) * 0.0004; // higher number for more zoom
// //           var Num2mod = Num2 + 1;
// //           var Num3 = window.scrollTo(0, 0) * 0.2; // Title speed
// //           var Num3mod = Num3 + 1;
